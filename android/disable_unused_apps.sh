...
# A nice project which explains each package detail: https://github.com/0x192/universal-android-debloater/blob/main/resources/assets/uad_lists.json
# this project cloned locally (for backup in any case).
